...
//creating one block of 32 threads each.
#include<iostream>
#include<time.h>
using namespace std;
#define DEBUG 0
...
#define NUMBER_OF_TILES_X 128
#define NUMBER_OF_TILES_Y 256
...
int main(){
	...
	cout<<"creating kernel with one block of 32 threads each."<<endl;
