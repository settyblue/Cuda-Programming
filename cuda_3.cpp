...
//creating four blocks of 1024 threads each.
#include<iostream>
#include<time.h>
using namespace std;
#define DEBUG 0
...
#define NUMBER_OF_TILES_X 16
#define NUMBER_OF_TILES_Y 16
...
int main(){
	...
	cout<<"creating kernel with four blocks of 1024 threads each."<<endl;
